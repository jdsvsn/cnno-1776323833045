...
const basePath = '/cnno-1776323833045';
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft and deliver exceptionally delicious and freshly baked cinnamon rolls, while providing outstanding customer service and fostering a warm, inviting atmosphere that brings comfort and joy to our community.</p>
                </div>
                <div className="space-y-2">
